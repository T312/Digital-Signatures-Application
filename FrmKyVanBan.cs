...
{
    public partial class FrmKyVanBan : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        private long D = 0L;
        private long E = 0L;
        ...
        private object richEditControlVanBan;

        public FrmKyVanBan()
        {
            InitializeComponent();
            repositoryItemTextEdit5.NullText = Program.bienD;
            repositoryItemTextEdit2.NullText = Program.bienN;
        }
        ...
        private void Openfile()
        {
            ...
            //string[] returnDocParts = new string[1];
        ...
        private void BtnNapKhoa_Click(object sender, EventArgs e)
        {
            ...
            if (ofd.ShowDialog() != DialogResult.Cancel)
            {
                try
                {
                    ...
                    repositoryItemTextEdit5.NullText = info.BienD;
        ...
        private void BarBtnKyVanBan_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            KyVanBan();
        }

        private void BarBtnLuuChuKy_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            LuuChuKy();
        }
        ...
        private void BarBtnDinhDang_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            
            string[] returnDocParts = new string[1];
            returnDocParts[0] = richEditControlVanBan.Text;
            returnDocParts[0] = richEditControlVanBan.Text.Remove(richEditControlVanBan.Text.IndexOf("\r"));
            ...
            try
            {
                ...
                if (dialog.ShowDialog() == DialogResult.OK)
                {
                    ...
                    writer.Flush();
                    writer.Close();
                    XtraMessageBox.Show("Bạn đã lưu văn bản định dạng lại", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }
            catch
            {
